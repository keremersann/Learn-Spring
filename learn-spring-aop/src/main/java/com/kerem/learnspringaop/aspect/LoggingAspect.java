...
public class LoggingAspect {
    ...
    @Before("com.kerem.learnspringaop.config.CommonPointcutConfig.allServicesConfigWithBean()")
    public void logMethodCallBefore(JoinPoint joinPoint){
        logger.info("Before Aspect - Method is called {} - with args {}", joinPoint, joinPoint.getArgs());
    }
    @After("com.kerem.learnspringaop.config.CommonPointcutConfig.businessPackageConfig()")
    ...
    @AfterReturning(pointcut = "com.kerem.learnspringaop.config.CommonPointcutConfig.repositoryPackageConfig()",
